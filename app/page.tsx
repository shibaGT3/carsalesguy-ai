...
const steps = [
  {
    ...
    description:
      "Pick your deal type — lease, finance, or cash — and tell us what you're shopping for.",
    icon: (
  ...
  {
    number: 2,
    title: "Get your dealer email",
    description:
      "We generate a professional negotiation email using strategies that actually work on dealers.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    number: 3,
    title: "Fine-tune it with AI chat",
    description:
      "Adjust the tone, add details, or ask insider questions about your deal — the AI knows the game.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    number: 4,
    title: "Send it and save thousands",
    description:
